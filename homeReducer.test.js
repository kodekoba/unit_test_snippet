...
describe('Testing homeReducer', () => {
    ...
    describe('Testing Default State', () => {
        ...
        it('Should return default with non-declared action', () => {
            expect(JSON.stringify(homeReducer(defaultState, {type: "undeclaredType", payload: "undeclaredPayload"}))).toBe("{\"genreMap\":{},\"featuredList\":[],\"shownList\":[],\"totalPages\":1,\"totalResults\":0,\"searchIsEmpty\":true,\"sortByRating\":true,\"searchVal\":\"\",\"resultPage\":1}");
        });
    ...
    describe('Testing Correct State', () => {
        ...
        it('Should set action.payload === genreMap with action.type === "SET_GENRE_MAP_SUCCESS"', () => {
            ...
            }))).toBe("{\"genreMap\":{\"12\":\"Adventure\",\"14\":\"Fantasy\"},\"featuredList\":[],\"shownList\":[],\"totalPages\":1,\"totalResults\":0,\"searchIsEmpty\":true,\"sortByRating\":true,\"searchVal\":\"\",\"resultPage\":1}");
        });
